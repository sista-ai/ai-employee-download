...
| -------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| macOS    | `Sistava-Mac.dmg`        | [Download](https://github.com/sista-ai/ai-employee-download/releases/latest/download/Sistava-Mac.dmg)        |
| Windows  | `Sistava-Windows.msi`    | [Download](https://github.com/sista-ai/ai-employee-download/releases/latest/download/Sistava-Windows.msi)    |
| Linux    | `Sistava-Linux.AppImage` | [Download](https://github.com/sista-ai/ai-employee-download/releases/latest/download/Sistava-Linux.AppImage) |
