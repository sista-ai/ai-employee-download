...
<h1 align="center">Sistava Desktop Controller</h1>
...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/Security-Sandboxed%20Execution-success?style=for-the-badge" alt="Security" />
...
<p align="center">
    <img src="https://sistava.com/site-assets-opt/screenshots/features/desktop-1600w.avif" alt="Sistava Desktop Controller - AI agents controlling the browser and computer" width="900" />
</p>

<p align="center">
  <details>
    <summary><strong>🔍 Keywords & Search Topics</strong></summary>
    <br/>
    <p align="center">
        <code>ai agent</code> ·
        <code>ai agents</code> ·
...
> [!TIP]
> That's it! No complex configuration files, no API keys to manage, and no zero-day setup required. [Full installation steps below.](#install--connect)

---

## What this is: the desktop runtime for your AI employees

**Sistava Desktop Controller** is a native desktop app (macOS, Windows, Linux) that acts as the **local execution runtime for your AI employees**. It gives an autonomous AI agent, running in the Sistava cloud, real hands on your machine: full browser use, computer use, file access, and terminal execution.
...
If you've seen *Browser Use*, *Anthropic Computer Use*, *OpenAI Operator*, or similar *agent orchestration* research, this is a production-grade version of that idea, wired into a full AI workforce platform.

### Architecture Overview

| Component | Layer | Core Functionality |
| :--- | :--- | :--- |
| **Sistava Cloud** | **The Brain** | Reasoning, long-term memory, multi-agent coordination, and sprint planning. |
| **Desktop Controller** | **The Hands** | Browser manipulation, mouse/keyboard input, file system access, and shell execution. |
...
> [!SECURITY]
> **No Password Handling:** Agents operate inside browser sessions you are already logged into. They never see, ask for, or store your credentials.

> [!IMPORTANT]
> **Dangerous Command Interception:** Dangerous patterns such as `rm -rf /`, `dd`, `mkfs`, `shutdown`, `sudo`, and fork bombs are automatically intercepted and blocked at the local desktop level before execution.

- **Approval gates** - mark sensitive actions so the AI employee has to ask before doing them
- **File sandboxing** - file access is strictly restricted to your home directory
- **Encrypted connection** - authenticated TLS WebSocket tied directly to your Sistava account
...
| OS | Installer | Download Link |
| :--- | :--- | :--- |
| **macOS** | `Sistava-Mac.dmg` | [Download macOS Installer](https://github.com/sista-ai/ai-employee-download/releases/latest/download/Sistava-Mac.dmg) |
| **Windows** | `Sistava-Windows.msi` | [Download Windows Installer](https://github.com/sista-ai/ai-employee-download/releases/latest/download/Sistava-Windows.msi) |
| **Linux** | `Sistava-Linux.AppImage` | [Download Linux AppImage](https://github.com/sista-ai/ai-employee-download/releases/latest/download/Sistava-Linux.AppImage) |

All releases & release notes: [github.com/sista-ai/ai-employee-download/releases](https://github.com/sista-ai/ai-employee-download/releases)
...
2. **Install and launch** Sistava Desktop Controller.
3. Click **Sign in with Sistava** - your browser opens to sistava.com, you approve, and the app connects automatically.
4. **Grant permissions** - grant the required OS permissions (Screen Recording + Accessibility on macOS, equivalents on other OSes).
5. **Start delegating** - head back to sistava.com; your AI agents now have hands on your desktop.
...
| :--- | :--- | :--- |
| **macOS** | macOS 12 (Monterey) or later (Apple Silicon & Intel) | Grant Screen Recording + Accessibility permissions on first launch |
| **Windows** | Windows 10 (64-bit) or later | `.msi` installer, standard user install |
| **Linux** | glibc 2.31+ (Ubuntu 20.04+, Fedora 36+, Debian 11+) | `.AppImage`, requires `chmod +x` before running |

*Note: A free [sistava.com](https://sistava.com) account is required to sign in and connect. The app itself is free to download.*

---

## Frequently Asked Questions

**What is the Sistava Desktop Controller?**
...
macOS, Windows, and Linux. See the [Download table](#download) and [System Requirements](#system-requirements) above.

**Does it work offline?**
No. The agents' reasoning runs in the Sistava cloud, so an active internet connection is required.
...
Install and launch the app, click **Sign in with Sistava**, approve in your browser, and grant OS permissions. Every AI employee you've hired on sistava.com then has hands on your computer. See [Install & Connect](#install--connect) above.
...
- **Setup Guide & Documentation:** [sistava.com/guide](https://sistava.com/en/guide)
- **Download Desktop App (Releases):** [github.com/sista-ai/ai-employee-download/releases](https://github.com/sista-ai/ai-employee-download/releases/latest)
- **White Label & Source Licensing:** [sistava.com/white-label](https://sistava.com/white-label)
